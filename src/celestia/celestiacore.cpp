...
#include <celengine/view3d/fisheyeprojectionmode.h>
...
void CelestiaCore::loadAsterismsFile(const std::filesystem::path &path) //NOSONAR
{
    std::ifstream asterismsFile(path, std::ios::in);
    if (!asterismsFile)
    {
